...
class Domain {
   ...
   void AllocateNodePersistent(Int_t numNode) // Node-centered
   {
      ...
      size_t dims[3] = {m_sizeX+1, 
                        m_sizeY+1, 
                        m_sizeZ+1};

      Mitos_add_symbol("m_x", &m_x[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_y", &m_y[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_z", &m_z[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_xd", &m_xd[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_yd", &m_yd[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_zd", &m_zd[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_xdd", &m_xdd[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_ydd", &m_ydd[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_zdd", &m_zdd[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_fx", &m_fx[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_fy", &m_fy[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_fz", &m_fz[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_nodalMass", &m_nodalMass[0], sizeof(Real_t), dims, 3);
#endif
   }
...
#if USE_MITOS
      // edgeNodes = edgeElems+1
      size_t dims[3] = {m_sizeX, 
                        m_sizeY, 
                        m_sizeZ};

      Mitos_add_symbol("m_lxim", &m_lxim[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_lxip", &m_lxip[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_letam", &m_letam[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_letap", &m_letap[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_lzetam", &m_lzetam[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_lzetap", &m_lzetap[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_elemBC", &m_elemBC[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_e", &m_e[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_p", &m_p[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_q", &m_q[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_ql", &m_ql[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_qq", &m_qq[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_v", &m_v[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_volo", &m_volo[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_delv", &m_delv[0], sizeof(Real_t), dims, 3);
      Mitos_add_symbol("m_vdov", &m_vdov[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_arealg", &m_arealg[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_ss", &m_ss[0], sizeof(Real_t), dims, 3);

      Mitos_add_symbol("m_elemMass", &m_elemMass[0], sizeof(Real_t), dims, 3);
#endif
   }
   ...
   void AllocateGradients(Int_t numElem, Int_t allElem)
   {
      ...
      Mitos_add_symbol("m_delx_xi", &m_delx_xi[0], sizeof(Real_t), dims, 3) ;
      Mitos_add_symbol("m_delx_eta", &m_delx_eta[0], sizeof(Real_t), dims, 3) ;
      Mitos_add_symbol("m_delx_zeta", &m_delx_zeta[0], sizeof(Real_t), dims, 3) ;
#endif
   }
   ...
   void AllocateStrains(Int_t numElem)
   {
      ...
      Mitos_add_symbol("m_dxx", &m_dxx[0], sizeof(Real_t), dims, 3) ;
      Mitos_add_symbol("m_dyy", &m_dyy[0], sizeof(Real_t), dims, 3) ;
      Mitos_add_symbol("m_dzz", &m_dzz[0], sizeof(Real_t), dims, 3) ;
#endif
   }
